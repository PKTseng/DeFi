...
const ExchangeAllTickersTable: React.FC<Props> = ({ tickers, getTrustScoreBadgeColor }) => (
  <div className="bg-gray-800 p-6 rounded-xl shadow-lg">
    <h2 className="text-2xl font-bold text-[#8dc647] mb-4">所有交易對</h2>
...
export default ExchangeAllTickersTable
